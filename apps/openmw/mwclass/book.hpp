...
namespace MWClass
{
    class Book : public MWWorld::Class
    {
        ...
        public:
            ...
            void insertObject(const MWWorld::Ptr& ptr, const std::string& mesh, osg::Quat rotation, MWPhysics::PhysicsSystem& physics, bool skipAnimated = false) const override;
