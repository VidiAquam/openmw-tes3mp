...
namespace MWWorld
{
    ...
    void Scene::deactivateCell(CellStore* cell, bool test)
    {
        ...
        */
        const ESM::Cell* cellPtr = cell->getCell();
        /*
            End of tes3mp addition
        */
        ...
        */
        if (!test) {
            mwmp::Main::get().getLocalPlayer()->storeCellState(*cellPtr, mwmp::CellState::UNLOAD);
        }
        /*
            End of tes3mp addition
        */
    ...
    /*
        Start of tes3mp addition
    */
    void Scene::unloadCell(MWWorld::CellStore *cell, bool test) {
        deactivateCell(cell);
        unloadInactiveCell(cell);
    }

    void Scene::loadCell (MWWorld::CellStore *cell, Loading::Listener* loadingListener, bool respawn, bool test) {
        loadInactiveCell (cell, loadingListener);
